...
object SparkHDFSWordCountComparison {
  ...
  private var localFilePath: File = new File("/home/acadgild/Desktop/Spark_Streaming/match")
  ...
  def main(args: Array[String]): Unit = {
    ...
    val conf = new SparkConf().setMaster("local[1]").setAppName("SparkHDFSWordCountComparisonApp")
